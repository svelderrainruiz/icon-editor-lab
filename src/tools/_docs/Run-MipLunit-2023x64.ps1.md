...
5. Invokes `.github/actions/run-unit-tests/RunUnitTests.ps1` (LUnit) targeting `vendor/labview-icon-editor/lv_icon_editor.lvproj`.  
...
| --- | --- | --- | --- |
| `ProjectPath` | string | `vendor/labview-icon-editor/lv_icon_editor.lvproj` | Project supplied to the LUnit helper. |
