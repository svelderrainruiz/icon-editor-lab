...
$rootContext = @{
  ...
  iconEditorProjectFile     = 'vendor/labview-icon-editor/lv_icon_editor.lvproj'
  buildPplNeeds             = '[test, version, enable-dev-mode]'
  buildPplRunsOn            = '[self-hosted, Windows, X64]'
  iconEditorRelativePath    = '${{ github.workspace }}/vendor/labview-icon-editor'
  lvlibpCurrentPath         = '${{ github.workspace }}/vendor/labview-icon-editor/resource/plugins/lv_icon.lvlibp'
  lvlibpNewPath             = '${{ github.workspace }}/vendor/labview-icon-editor/resource/plugins/lv_icon_${{ matrix.suffix }}.lvlibp'
  lvlibpArtifactPath        = 'vendor/labview-icon-editor/resource/plugins/lv_icon_${{ matrix.suffix }}.lvlibp'
